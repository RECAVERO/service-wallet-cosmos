...
public class WalletRepositoryImpl implements WalletRepository {
  ...
  public Uni<WalletDto> updateWallet(WalletDto walletDto) {
    ...
    Bson updates = combine(
        ...
        set("numberCard", walletDto.getNumberCard()),
  ...
  public Uni<WalletDto> deleteWallet(WalletDto walletDto) {
    ...
    Bson filter = eq("numberTelephone", walletDto.getNumberTelephone());
    Bson updates = combine(set("updated_datetime", walletDto.getUpdated_datetime()), set("active", "N"));
  ...
  public Uni<WalletDto> signInWallet(WalletDto walletDto) {
    ...
    Bson filter = combine(
        eq("numberTelephone", walletDto.getNumberTelephone()),
        eq("password", walletDto.getPassword())
    );
